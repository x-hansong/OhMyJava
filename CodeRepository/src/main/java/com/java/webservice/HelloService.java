...
import com.java.webservice.Hello;
 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://webservice.java.com/", wsdlLocation = "http://localhost:8080/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://webservice.java.com/", "HelloService");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://webservice.java.com/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.java.com/", "HelloPort"), Hello.class, features);
    }
